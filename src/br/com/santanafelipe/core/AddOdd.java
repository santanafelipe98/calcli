 ...
 * @version 0.1
 */
public class AddOdd extends Add {
	
	public AddOdd() {
		super();
	}
	
	public AddOdd(String[] flags, String[] params) {
		super(flags, params);
	}
	
	public AddOdd(String[] flags, String[] params, AddOdd subcommand) {
	...
	@Override
	public AddOdd clone() {
		return new AddOdd(this.flags, this.params, (AddOdd) this.subcommand);
	}
